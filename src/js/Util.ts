 ...
 */
export function roundRect(ctx:CanvasRenderingContext2D, x:number, y:number, width:number, height:number, radiusX:number=.5, fill:boolean=true, stroke:boolean=true) {
...
export function generateRandomColor(useGrayscale:boolean) {
